    ...
    onFormSubmit = (values) => {
        ...
        if (this.props.initialValues.id) {
            ...
            const newEvent = {
                ...values,
                id: cuid(),
                hostPhotoURL: '/assets/user/user.png',
                hostedBy: 'Bob'
            }
                ...
                <Grid.Column width={10}>
                    <Segment>
                        <Form onSubmit={this.props.handleSubmit(this.onFormSubmit)}>
                            ...
                            <Field name='category' type='text' options={category} component={SelectInput} placeholder='What is your event' />
                            ...
                            <Button negative type="button" onClick={this.props.history.goBack}>Cancel</Button>
                        </Form>
                    </Segment>
                </Grid.Column>
            </Grid>
